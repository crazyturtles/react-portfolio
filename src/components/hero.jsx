		...
		<section className="relative h-hero flex items-center justify-center bg-gradient-to-br from-primary/10 to-accent/10 dark:from-primary-dark/5 dark:to-accent-dark/5">
			<div className="container mx-auto px-4">
				<div className="animate-fade-in space-y-6 text-center">
					<h1 className="font-heading dark:font-heading-dark text-5xl font-bold text-primary dark:text-primary-dark">
						Hi, I'm{" "}
						<span className="text-accent dark:text-accent-dark">
							Rohan Matharu
						</span>
					</h1>
					<p className="mx-auto max-w-2xl text-xl font-sans dark:font-sans-dark text-secondary dark:text-secondary-dark">
